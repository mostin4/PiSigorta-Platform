...
export default function ProposalCard({ title, description, choices, onVote }: ProposalCardProps) {
      ...
      <div className="mt-4 flex flex-col gap-2">
        {choices.map((choice) => (
          <button
            ...
            className={`border px-4 py-2.5 rounded-lg text-left transition-all ${
              selected === choice
